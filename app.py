...
def status_payload():
    ...
    return {"candice":"online" if engine_ready else "starting","engine_ready":engine_ready,"engine_error":engine_error,"feed":fs,"brain":bs,"timezone":"Asia/Dubai","mode":"READ_ONLY","market_mode":"FLEX_TIME","auto_trade":False,"martingale":False}
...
async def _engine_loop():
    ...
    try:
        ...
        log.info("CANDICE_STARTING | timezone=Asia/Dubai | READ_ONLY | MARKET_MODE=FLEX_TIME")
        telegram.start(); await feed.start(); engine_ready=True; engine_error=None
        log.info("CANDICE_ENGINE_STARTED | Dubai UTC+04:00 | READ_ONLY | MARKET_MODE=FLEX_TIME | AUTO_TRADE=OFF | MARTINGALE=OFF")
