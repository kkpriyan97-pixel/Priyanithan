...
def _has_flex_marker(node):
    if not isinstance(node, dict):
        return False
    # OlympTrade can describe the same UI mode as "Flex", "Flex Time",
    # "flex_time", or through a boolean availability flag. Treat all of
    # these explicit markers as the same FLEX market mode. Never infer Flex
    # from an asset symbol alone.
